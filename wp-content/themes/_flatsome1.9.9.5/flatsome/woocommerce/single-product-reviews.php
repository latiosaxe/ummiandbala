...
//
//			echo '<h2>'.sprintf( _n('<strong>%s comentario</strong>', '<strong>%s comentarios</strong>', $count, 'woocommerce'), '<span itemprop="ratingCount" class="count">'.$count.'</span>', wptexturize($post->post_title) ).'</h2>';
//
//			echo '</div>';
//
//		} else {
...
//			echo '<hr/>';
	...
	?>
		...
		<?php
		if ( have_comments() ) :
			echo '</div><div id="add_review" class="large-5 columns"><div class="inner"><div class="auxiliar">';
				else :
			echo '</div><div id="add_review" class="large-12 columns"><div class="inner"><div class="auxiliar">';
		endif;
