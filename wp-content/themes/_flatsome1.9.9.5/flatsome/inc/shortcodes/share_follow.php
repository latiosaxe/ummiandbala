...
function shareShortcode($atts, $content = null) {
	...
	<div class="social-icons share-row">
		...
		<?php if($flatsome_opt['social_icons']['facebook']) { ?>
			  <a href="http://www.facebook.com/sharer.php?u=<?php echo $permalink; ?>" target="_blank" class="icon icon_facebook tip-<?php echo $tooltip ?>" title="<?php _e('Compartir en Facebook','flatsome'); ?>"><div class="auxiliar"><span class="icon-facebook"></span></div></a>
		<?php } ?>
		<?php if($flatsome_opt['social_icons']['twitter']) { ?>
            <a href="https://twitter.com/share?url=<?php echo $permalink; ?>" target="_blank" class="icon icon_twitter tip-<?php echo $tooltip ?>" title="<?php _e('Compartir en Twitter','flatsome'); ?>"><div class="auxiliar"><span class="icon-twitter"></span></div></a>
		<?php } ?>
		<?php if($flatsome_opt['social_icons']['email']) { ?>
            <a href="mailto:enteryour@addresshere.com?subject=<?php echo $post_title; ?>&amp;body=Check%20this%20out:%20<?php echo $permalink; ?>" class="icon icon_email tip-<?php echo $tooltip ?>" title="<?php _e('Envíar a un amigo','flatsome'); ?>"><div class="auxiliar"><span class="icon-envelop"></span></div></a>
		<?php } ?>
		<?php if($flatsome_opt['social_icons']['pinterest']) { ?>
            <a href="//pinterest.com/pin/create/button/?url=<?php echo $permalink; ?>&amp;media=<?php echo $featured_image_2; ?>&amp;description=<?php echo $post_title; ?>" target="_blank" class="icon icon_pintrest tip-<?php echo $tooltip ?>" title="<?php _e('Pinear en Pinterest','flatsome'); ?>"><div class="auxiliar"><span class="icon-pinterest"></span></div></a>
		<?php } ?>
		<?php if($flatsome_opt['social_icons']['googleplus']) { ?>
            <a href="//plus.google.com/share?url=<?php echo $permalink; ?>" target="_blank" class="icon icon_googleplus tip-<?php echo $tooltip ?>" title="<?php _e('Compartir en Google+','flatsome'); ?>"><div class="auxiliar"><span class="icon-google-plus"></span></div></a>
		<?php } ?>
    </div>
