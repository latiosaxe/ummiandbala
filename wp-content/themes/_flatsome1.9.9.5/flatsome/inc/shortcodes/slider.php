...
<div id="slider_<?php echo $sliderrandomid ?>" class="iosSlider default" style="<?php if($height) echo 'min-height:'.$height.'; height:'.$height; ?>">
        ...
        <div class="sliderControlls <?php echo $nav_color?> <?php if($hide_nav == 'false') echo 'hide_nav'; ?>">
            ...
            <a href="javascript:void(0)" class="nextSlide next_<?php echo $sliderrandomid; ?>"><strong><span class="icon-angle-left"></span></strong></a>
            <a href="javascript:void(0)" class="prevSlide prev_<?php echo $sliderrandomid; ?>"><strong><span class="icon-angle-right"></span></strong></a>
            </div>
            <?php } ?>
