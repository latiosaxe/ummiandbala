...
function flatsome_scripts() {
	...
	/* styles */
	wp_enqueue_style( 'flatsome-icons', get_template_directory_uri() .'/css/fonts.css', array(), '1.9.9.5', 'all' );
	...
	wp_enqueue_script( 'flatsome-modernizer', get_template_directory_uri() .'/js/modernizr.js?v=1.9.9.5', array( 'jquery' ), '20120202', true );
 	wp_enqueue_script( 'flatsome-plugins', get_template_directory_uri() .'/js/plugins.js?v=1.9.9.5', array( 'jquery' ), '20120202', true );
...
function woo_custom_cart_button_text() {
    return __( '<span class="auxiliar">Añadir a mi bolsa<img src="http://ummiandbala.com.mx/shop/wp-content/themes/flatsome1.9.9.5/flatsome/images/icons/bolsita.png" alt="Añadir a la bolsa"></span>', 'woocommerce');
}
...
//    $fields['billing']['billing_phone']['required'] = false;
    ...
    $fields['billing']['billing_last_name']['placeholder'] = 'Peréz Peréz';
    $fields['billing']['billing_company']['label'] = 'Dirección';
    $fields['billing']['billing_company']['placeholder'] = 'Calle ABC 123 Int. A';
    $fields['billing']['billing_company']['required'] = true;
    $fields['billing']['billing_address_1']['label'] = 'Colonia';
    $fields['billing']['billing_address_1']['placeholder'] = 'Colonia';
    $fields['billing']['billing_address_1']['required'] = true;
    $fields['billing']['billing_address_2']['label'] = 'Delegación o Municipio';
    $fields['billing']['billing_address_2']['placeholder'] = 'Delegación';
    ...
    $fields['billing']['billing_email']['placeholder'] = 'correo@email.com';
    $fields['billing']['billing_email']['required'] = true;
    $fields['billing']['billing_phone']['placeholder'] = '+1 (321) 555 1234';

    $fields['shipping']['billing_first_name']['placeholder'] = 'Juan';
    $fields['shipping']['billing_last_name']['label'] = 'Apellidos';
    $fields['shipping']['billing_last_name']['placeholder'] = 'Peréz Peréz';
    $fields['shipping']['billing_company']['label'] = 'Dirección';
    $fields['shipping']['billing_company']['placeholder'] = 'Calle ABC 123 Int. A';
    $fields['shipping']['billing_company']['required'] = true;
    $fields['shipping']['billing_address_1']['label'] = 'Colonia';
    $fields['shipping']['billing_address_1']['placeholder'] = 'Colonia';
    $fields['shipping']['billing_address_1']['required'] = true;
    $fields['shipping']['billing_address_2']['label'] = 'Delegación o Municipio';
    $fields['shipping']['billing_address_2']['placeholder'] = 'Delegación';
    $fields['shipping']['billing_address_2']['required'] = true;
    $fields['shipping']['billing_city']['label'] = 'Ciudad';
    $fields['shipping']['billing_city']['placeholder'] = 'Ciudad';
    $fields['shipping']['billing_city']['required'] = true;
    $fields['shipping']['billing_state']['label'] = 'Estado';
    $fields['shipping']['billing_state']['placeholder'] = 'Estado';
    $fields['shipping']['billing_state']['required'] = true;
    $fields['shipping']['billing_postcode']['label'] = 'Código Postal';
    $fields['shipping']['billing_postcode']['placeholder'] = '12345';
    $fields['shipping']['billing_postcode']['required'] = true;
    $fields['shipping']['billing_email']['label'] = 'Email';
    $fields['shipping']['billing_email']['placeholder'] = 'correo@email.com';
    $fields['shipping']['billing_email']['required'] = true;
    $fields['shipping']['billing_phone']['placeholder'] = '+1 (321) 555 1234';
