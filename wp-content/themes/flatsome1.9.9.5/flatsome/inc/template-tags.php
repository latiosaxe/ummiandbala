        ...
        <div class="nav-dropdown">
            ...
            <div class="cart_list">
                ...
                endforeach;
                    ...
                    <a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" class="button expand uppercase"><?php _e('Ver bolsa de compras', 'woocommerce'); ?></a>

                    <a href="<?php echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>" class="button secondary expand uppercase"><?php _e( 'Terminar compra', 'woocommerce' ); ?></a>

                    <?php
                else: echo '<p class="empty">'.__('Bolsa de compras vacía','woocommerce').'</p>'; endif;
                ?>
...
//                    echo '<a href="#tab-reviews" class="scroll-to-reviews"><div class="star-rating tip-top" title="'.$count.' review(s)"><span style="width:'.($average*16).'px"><span itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" class="rating"><span itemprop="ratingValue">'.$average.'</span><span itemprop="reviewCount" class="hidden">'.$count.'</span></span> '.__('out of 5', 'woocommerce').'</span></div></a>';
                    echo '<a href="#tab-reviews" class="scroll-to-reviews"><div class="star-rating" title="'.$count.' review(s)"><span style="width:'.($average*16).'px"><span itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" class="rating"><span itemprop="ratingValue">'.$average.'</span><span itemprop="reviewCount" class="hidden">'.$count.'</span></span> '.__('out of 5', 'woocommerce').'</span></div></a>';
