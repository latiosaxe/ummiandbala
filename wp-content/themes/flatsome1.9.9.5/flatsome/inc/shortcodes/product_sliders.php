		...
		<div class="row column-slider">
            ...
            <div class="sliderControlls">
		        <div class="sliderNav small hide-for-small">
		       		 <a href="javascript:void(0)" class="nextSlide disabled prev_<?php echo $sliderrandomid ?>"><strong><span class="icon-angle-left"></span></strong></a>
		       		 <a href="javascript:void(0)" class="prevSlide next_<?php echo $sliderrandomid ?>"><strong><span class="icon-angle-right"></span></strong></a>
		        </div>
       		</div><!-- .sliderControlls -->
