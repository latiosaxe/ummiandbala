...
<?php $from = strip_tags($product->get_categories(' ', '', '')); ?>
<li class="product-small <?php echo($from) ?><?php if($stock_status == "1") { ?>out-of-stock<?php }?> <?php echo $flatsome_opt['grid_style']; ?>">
        ...
        <div class="product-image hover_<?php echo $flatsome_opt['product_hover']; ?>">
            ...
            if ( $attachment_ids ) {
                ...
                <div class="back-image">
                    <div class="auxiliar">
                        <a href="#" alt="Ver articulo" class="tip-top tooltipstered">
            ...
            <div class="back-image">
                <div class="auxiliar">
                    <a href="<?php the_permalink(); ?>" alt="Ver articulo" class="tip-top tooltipstered">
                        <div class="icon" alt="Ver articulo"></div>
                    </a>
                </div>
            </div>
