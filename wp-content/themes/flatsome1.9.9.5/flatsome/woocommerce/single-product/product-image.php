...
<!--                	<a href="--><?php //echo $src[0] ?><!--"  title="--><?php //echo $src_title; ?><!--">-->
                	<span itemprop="image" style="display: block">
                        <img src="<?php echo $src_small[0]; ?>" alt="<?php echo $src_title; ?>" title="<?php echo $src_title; ?>"/>
                    </span>
				...
				<?php
					...
					if ( $attachment_ids ) {
						...
						foreach ( $attachment_ids as $attachment_id ) {
							...
							printf( '<div class="slide"><a href="%s" title="%s"><span>%s</span></a></div>', wp_get_attachment_url( $attachment_id ),get_post($attachment_id)->post_title, wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ) ) );
...
<!--                     <a href="javascript:void(0)" class="nextSlide prev_product_slider"><strong><span class="icon-angle-left"></span></strong></a>-->
<!--                     <a href="javascript:void(0)" class="prevSlide next_product_slider"><strong><span class="icon-angle-right"></span></strong></a>-->
<!--                </div>-->
<!--       		</div>-->
		</div>
...
<!--        	 <div class="sliderControlls dark">-->
<!--				  <div class="sliderNav  small hide-for-small">-->
<!--		       		 <a href="javascript:void(0)" class="nextSlide prev_thumb_slider disabled"><strong><span class="icon-angle-left"></span></strong></a>-->
<!--		       		 <a href="javascript:void(0)" class="prevSlide next_thumb_slider disabled"><strong><span class="icon-angle-right"></span></strong></a>-->
<!--		        </div>-->
<!--       		</div><!-- .sliderControlls -->
<!--		</div>-->
        <?php } ?>
