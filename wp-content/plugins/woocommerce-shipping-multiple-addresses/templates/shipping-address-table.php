...
<form method="post" action="" id="address_form" class="AdressTable">
    ...
    <div>
        <a class="h2-link" href="<?php echo $add_url; ?>"><span class="auxiliar"><?php _e('Agregar nueva dirección de envío', 'wc_shipping_multiple_address'); ?></span></a>
    ...
    <table class="shop_table cart" cellspacing="0">
        ...
        <tr>
            ...
            <th class="product-quantity hidden" width="100"><?php _e( 'Quantity', 'woocommerce' ); ?></th>
            <th class="shipping-address"><?php _e( 'Shipping Address', 'woocommerce' ); ?></th>
            <th class="remove-item hidden" width="1">&nbsp;</th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        foreach ($contents as $key => $value):
            ...
            for ( $x = 0; $x < $value['quantity']; $x++ ):
                ...
                <tr>
                    <td>
                        <div class="thumbnail">
                            ...
                            if ( ! $_product->is_visible() )
                                ...
                                printf( '<a href="%s" target="_blank">%s</a>', $_product->get_permalink(), $thumbnail );
                            ?>
                        </div>
                    ...
                    <td class="hidden"><input type="submit" name="delete_line" class="button delete-line-item" data-key="<?php echo $key; ?>" data-index="<?php echo $x; ?>" value="<?php _e('Delete', 'wc_shipping_multiple_address'); ?>" /></td>
                </tr>
            <?php
            endfor;
        endforeach;
    ...
    <div class="form-row">
        ...
        <div class="update-shipping-addresses hidden">
            <input type="submit" name="update_quantities" class="button" value="<?php _e('Aztualizar', 'wc_shipping_multiple_address'); ?>" />
        </div>

        <div class="set-shipping-addresses">
            <input class="button alt" type="submit" name="set_addresses" value="<?php echo __('Salvar direcciones y continuar', 'wc_shipping_multiple_address'); ?>" />
        </div>
