	...
	class jckWooThumbs_config {
		...
		public function setSections() {
				...
				'fields' => array(			
					...
					array(
						...
						'options'  => array(
							'left' => array(
								'alt' => 'Left', 
								'img' => $this->pluginUrl.'img/sel-sliderL.png'
							),
							'right' => array(
								'alt' => 'Right', 
								'img' => $this->pluginUrl.'img/sel-sliderR.png'
							),
							'none' => array(
								'alt' => 'None', 
								'img' => $this->pluginUrl.'img/sel-sliderN.png'
							)
						),
						'default' => 'left'
					),
				...
				'fields' => array(
					...
					array(
						...
						'options'  => array(
							'above' => array(
								'alt' => 'Above', 
								'img' => $this->pluginUrl.'img/sel-thumbsA.png'
							),
							'below' => array(
								'alt' => 'Below', 
								'img' => $this->pluginUrl.'img/sel-thumbsB.png'
							),
							'left' => array(
								'alt' => 'Left', 
								'img' => $this->pluginUrl.'img/sel-thumbsL.png'
							),
							'right' => array(
								'alt' => 'Right', 
								'img' => $this->pluginUrl.'img/sel-thumbsR.png'
							)
						),
						'default' => 'below'
					),
			...
			$this->sections[] = array(
				...
				'desc' => __('If you want to use the Lightbox, please ensure "<strong>Enable Lightbox</strong>" is checked in your WooCommerce settings.', $this->pluginSlug),
